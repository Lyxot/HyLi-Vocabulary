...
import xyz.hyli.vocabulary.ui.composeprefs3.ifNotNullThen
...
fun EditTextPref(
    ...
    dialogBackgroundColor: Color = HyLiVocabularyColorScheme().background,
        ...
        AlertDialog(
            ...
            confirmButton = {
                TextButton(
                    ...
                    Text(stringResource(id = R.string.composeprefs_save), style = HyLiVocabularyTypography.bodyLarge)
                }
            },
            dismissButton = {
                TextButton(
                    ...
                    Text(stringResource(id = R.string.composeprefs_cancel), style = HyLiVocabularyTypography.bodyLarge)
                }
            },
...
fun DialogHeader(dialogTitle: String?, dialogMessage: String?) {
    Column(modifier = Modifier.padding(16.dp)) {
        dialogTitle.ifNotNullThen {
            Text(
                text = dialogTitle!!,
                style = HyLiVocabularyTypography.titleLarge
            )
        }?.invoke()
        ...
        dialogMessage.ifNotNullThen {
            Text(
                text = dialogMessage!!,
                style = HyLiVocabularyTypography.bodyLarge
            )
        }?.invoke()
    }
}
