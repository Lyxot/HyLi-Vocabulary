        ...
        AlertDialog(
                        ...
                        items(entriesList) { current ->
                            ...
                            Row(
                                ...
                                Checkbox(
                                    ...
                                    colors = CheckboxDefaults.colors(checkedColor = HyLiVocabularyColorScheme().primary)
                                )
                                Text(
                                    text = current.second,
            ...
            confirmButton = {
                TextButton(
                    ...
                    Text(text = stringResource(id = R.string.composeprefs_select), style = HyLiVocabularyTypography.bodyLarge)
                }
            },
