...
fun ListPref(
    ...
    dialogBackgroundColor: Color = HyLiVocabularyColorScheme().surface,
    contentColor: Color = contentColorFor(dialogBackgroundColor),
    textColor: Color = HyLiVocabularyColorScheme().onBackground,
    selectionColor: Color = HyLiVocabularyColorScheme().primary,
    buttonColor: Color = HyLiVocabularyColorScheme().primary,
        ...
        AlertDialog(
                    ...
                    LazyColumn {
                        ...
                        items(entriesList) { current ->
                            ...
                            Row(
                                ...
                                Text(
                                    text = current.second,
                                    style = HyLiVocabularyTypography.bodyMedium,
                                    color = textColor
                                )
            ...
            confirmButton = {
                TextButton(
                    ...
                    Text(stringResource(id = R.string.composeprefs_cancel), style = HyLiVocabularyTypography.bodyLarge, color = buttonColor)
                }
            },
